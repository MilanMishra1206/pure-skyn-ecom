    ...
    <div className="w-full bg-white shadow-md p-4 rounded-xl">
      ...
      {isCollectionPage && (
        <div className="mb-6 pb-4 border-b border-gray-200">
          <h2 className="text-xl font-bold mb-3 font-poppins text-gray-800">
            Shop By Category
          </h2>
                ...
                className={`w-full text-left cursor-pointer py-2 px-3 rounded transition-all duration-200 text-sm font-medium capitalize 
                  ${
                    selectedCategory === key
                      ? "bg-gray-100 font-semibold border-l-4" // Keep background, border, and boldness
                      : "text-gray-600 hover:bg-gray-50"
                  }`}
                style={
                  selectedCategory === key
      ...
      <h2 className="text-xl font-bold mb-4 font-poppins text-gray-800">
        {isCollectionPage
          ? "Filter By Type"
          : `${toTitleCase(selectedCategory)} Types`}
      </h2>
